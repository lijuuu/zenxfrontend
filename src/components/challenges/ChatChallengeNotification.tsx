...
interface ChatChallengeNotificationProps {
  challenge: {
    id: string;
    title: string;
    isPrivate: boolean;
...
const ChatChallengeNotification: React.FC<ChatChallengeNotificationProps> = ({
  challenge,
  onAccept,
  onDecline
}) => {
...
export default ChatChallengeNotification;
