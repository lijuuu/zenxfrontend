...
interface PrivateChallengeAccessModalProps {
  isOpen: boolean;
  onClose: () => void;
}

const PrivateChallengeAccessModal: React.FC<PrivateChallengeAccessModalProps> = ({
  isOpen,
  onClose,
}) => {
...
export default PrivateChallengeAccessModal;
