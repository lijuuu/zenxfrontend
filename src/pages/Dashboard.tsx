...
const Dashboard = () => {
  ...
  const { problems, status: problemsStatus } = useAppSelector((state) => state.problems);
  const { challenges, status: challengesStatus } = useAppSelector((state) => state.challenges);
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 my-6">
            ...
            <StatsCard
              ...
              change={`Personal best: ${profile?.longestStreak || 0}`}
            />
            <StatsCard
              title="Global Rank"
