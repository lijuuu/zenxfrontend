...
import { Trophy, RefreshCw, Globe, Flag, Medal } from 'lucide-react';
...
const Leaderboard = () => {
  ...
  const UserRow = memo(({ user, rank }: { user: LeaderboardUser; rank: number }) => (
                  ...
                  <Table>
                    <TableHeader>
                      <TableRow className="border-b border-zinc-700/50 bg-zinc-900/30">
                        <TableHead className="w-16 text-left text-xs font-medium text-zinc-500 uppercase tracking-wider">
                          Rank
                        </TableHead>
                        <TableHead className="text-left text-xs font-medium text-zinc-500 uppercase tracking-wider">
                          User
                        </TableHead>
                        <TableHead className="text-right text-xs font-medium text-zinc-500 uppercase tracking-wider">
                          Score
                        </TableHead>
                      </TableRow>
                    </TableHeader>
